<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"C:\phpStudy\WWW\tp50\public/../app/admin\view\goods\index.html";i:1539583852;}*/ ?>
  ...
  <!-- start goods list -->
	<div class="list-div" id="listDiv">
		...
		<?php foreach($goodsList as $val): ?>
				<tr>
					<td><input type="checkbox" name="checkboxes[]" value="<?php echo $val['goods_id']; ?>"><?php echo $val['goods_id']; ?></td>
					<td class="first-cell"><span><?php echo $val['goods_name']; ?></span></td>
					<td><span><?php echo $val['goods_sn']; ?></span></td>
					<td align="right"><span><?php echo $val['shop_price']; ?></span></td>

                    
					<td align="center">
						<?php if($val['is_on_sale'] == 1): ?>
					...
					<td align="right"><span onclick=""><?php echo $val['goods_number']; ?></span></td>
					<td align="center">
						...
						<?php if($val['product'] == 1): ?>
						<a href="<?php echo url('product',['goods_id'=>$val['goods_id']]); ?>" title="货品列表"><img src="images/icon_docs.gif" width="16" height="16" border="0"></a>    
						<?php endif; ?>      
					</td>
				</tr>
	    <?php endforeach; ?>
