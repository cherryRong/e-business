<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"C:\phpStudy\WWW\tp50\public/../app/admin\view\attribute\add.html";i:1539157621;}*/ ?>
...
<h1>
<span class="action-span"><a href="<?php echo url('index',['type_id'=>$type_id]); ?>">商品属性</a></span>
<span class="action-span1"><a href="index.php?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加属性 </span>
<div style="clear:both"></div>
</h1>

<div class="main-div">
  <form action="<?php echo url('add'); ?>" method="post" name="theForm" >
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
          <select name="type_id" >
             ...
             <option value="<?php echo $val['type_id']; ?>"  <?php if($val['type_id'] == $type_id): ?> selected <?php endif; ?>>
      ...
      <tr>
        ...
        <td>
            ...
            规格         
            <input type="radio" name="attr_index" value="1"> 
            属性          
                  
            <br><span class="notice-span" style="display:block" id="noticeAttrType">
            选择"规格"时，可以对商品该属性设置多个值，同时还能对不同属性值指定不同的价格加价，用户购买商品时需要选定具体的属性值。
            选择"属性"时，商品的该属性值只能设置一个值，用户只能查看该值。
            </span>
        </td>
      </tr>
      <tr>
...
<script>
    $(function(){
        $('[name="attr_input_type"]').click(function(){
            var value = $(this).val();
            if(value>0){
               //可用
               $('[name="attr_values"]').attr('disabled',false);
            }else{
