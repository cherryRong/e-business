<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"C:\phpStudy\WWW\tp50\public/../app/admin\view\attribute\index.html";i:1539157263;}*/ ?>
...
<h1>
<span class="action-span"><a href="<?php echo url('add',array('type_id'=>$type_id)); ?>">添加属性</a></span>
...
<div class="list-div" id="listDiv">
  ...
  <table cellpadding="3" cellspacing="1">
    ...
    <?php foreach($attrList as $val): ?>
    <tr>
			<td nowrap="true" valign="top">
         <span><input value="<?php echo $val['attr_id']; ?>" name="checkboxes[]" type="checkbox"><?php echo $val['attr_id']; ?></span>
      </td>
			<td class="first-cell" nowrap="true" valign="top">
         <span ><?php echo $val['attr_name']; ?></span>
      </td>
			<td nowrap="true" valign="top"><span><?php echo $val['type_id']; ?></span></td>
			<td nowrap="true" valign="top"><span><?php echo $val['attr_input_type']; ?></span></td>

			<td valign="top"><span><?php echo $val['attr_values']; ?></span></td>
