<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"C:\phpStudy\WWW\tp50\public/../app/index\view\cat\index.html";i:1539761151;s:54:"C:\phpStudy\WWW\tp50\app\index\view\public\header.html";i:1540187344;s:52:"C:\phpStudy\WWW\tp50\app\index\view\public\menu.html";i:1539658454;}*/ ?>
...
<div class="i_bg">
	<div class="postion">
    	<span class="fl">
           全部 > 
           <?php foreach($bread as $val): ?>
              <a href="<?php echo url('index',['cat_id'=>$val['cat_id']]); ?>"><?php echo $val['cat_name']; ?></a> > 
           <?php endforeach; ?>
        </span>
        <span class="n_ch">
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <?php foreach($goodsList as $val): ?>
                	<li>
                    	<div class="img"><a href="<?php echo url('Goods/index',['goods_id'=>$val['goods_id']]); ?>"><img src="/uploads/<?php echo $val['goods_thumb']; ?>" width="210" height="185" /></a></div>
                        <div class="price">
                            <font>￥<span><?php echo $val['shop_price']; ?></span></font> &nbsp;
                        </div>
                        <div class="name"><a href="<?php echo url('Goods/index',['goods_id'=>$val['goods_id']]); ?>"><?php echo $val['goods_name']; ?></a></div>
                        <div class="carbg">
