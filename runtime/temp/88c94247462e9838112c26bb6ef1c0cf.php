<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"C:\phpStudy\WWW\tp50\public/../app/admin\view\index\menu.html";i:1542684821;}*/ ?>
...
<head>
  ...
  <base href="/admin/" />
	...
	<style type="text/css">
		...
		.menu-item { background: url(images/menu_arrow.gif) no-repeat 0px 3px; font-weight: normal;}
	...
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="images/menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
			</span>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="<?php echo url('Brand/index'); ?>" target="main-frame">品牌管理</a></li>
              <li class="menu-item"><a href="<?php echo url('Cat/index'); ?>" target="main-frame">分类管理</a></li>
              <li class="menu-item"><a href="<?php echo url('Type/index'); ?>" target="main-frame">类型管理</a></li>
              <li class="menu-item"><a href="<?php echo url('Goods/index'); ?>" target="main-frame">商品管理</a></li>
				...
				<li class="collapse" key="07_content" name="menu"> 文章管理        
					<ul style="display: none;">
				...
				<li class="explode" key="08_members" name="menu"> 会员管理        
					<ul style="display: block;">
				...
				<li class="collapse" key="10_priv_admin" name="menu"> 权限管理        
					<ul style="display: none;">
						<li class="menu-item"><a href="<?php echo url('Role/index'); ?>" target="main-frame">角色列表</a></li>
            <li class="menu-item"><a href="<?php echo url('Admin/index'); ?>" target="main-frame">用户列表</a></li>
            <li class="menu-item"><a href="<?php echo url('Node/index'); ?>" target="main-frame">节点列表</a></li>
					
					</ul>
				</li>
				<li class="collapse" key="11_system" name="menu"> 系统设置        
					<ul style="display: none;">
				...
				<li class="collapse" key="12_template" name="menu"> 模板管理        
					<ul style="display: none;">
				...
				<li class="collapse" key="13_backup" name="menu"> 数据库管理        
					<ul style="display: none;">
