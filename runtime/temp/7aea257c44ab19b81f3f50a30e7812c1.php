<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"C:\phpStudy\WWW\tp50\public/../app/admin\view\type\index.html";i:1539157802;}*/ ?>
...
<h1>
<span class="action-span"><a href="<?php echo url('add'); ?>">新建商品类型</a></span>
...
<div class="list-div" id="listDiv">
	...
	<table width="100%" cellpadding="3" cellspacing="1" id="listTable">
      ...
      <?php foreach($typeList as $val): ?>
			<tr>
				<td class="first-cell"><span onclick="javascript:listTable.edit(this, 'edit_type_name', 1)"><?php echo $val['type_name']; ?></span></td>
				<td align="right"><?php echo $val['num']; ?></td>
				<td align="center"><?php echo $val['is_show']; ?></td>
				<td align="center">
				  <a href="<?php echo url('Attribute/index',array('type_id'=>$val['type_id'])); ?>" title="属性列表">属性列表</a> |
