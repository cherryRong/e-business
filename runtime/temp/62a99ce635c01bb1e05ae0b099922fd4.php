<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"C:\phpStudy\WWW\tp50\public/../app/index\view\index\index.html";i:1539744105;s:54:"C:\phpStudy\WWW\tp50\app\index\view\public\header.html";i:1540187344;s:52:"C:\phpStudy\WWW\tp50\app\index\view\public\menu.html";i:1539658454;}*/ ?>
...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="Login.html">登录</a>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="<?php echo url('Orderlist/index'); ?>">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="menu_bg">
	<div class="menu">
    	...
    	<div class="nav">
            ...
            <div class="leftNav"    <?php if($flag == 0): ?> style="display:none"  <?php endif; ?> >
                <ul>      
                <?php foreach($cat as $key => $value): ?>
                    <li>
                    
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="images/nav<?php echo $key+1; ?>.png" /></span>
                            <!-- 一级分类 -->
                            <span class="fl"><?php echo $value['cat_name']; ?></span>
                        </div>
                        <div class="zj">
                            <div class="zj_l">
                            <?php foreach($value['son'] as $val): ?>
                                <div class="zj_l_c">
                                    <!-- 二级分类 -->
                                    <h2>  <a href="<?php echo url('Cat/index',['cat_id'=>$val['cat_id']]); ?>"><?php echo $val['cat_name']; ?></a></h2>
                                      <?php foreach($val['son'] as $v): ?>
                                      <!-- 三级分类 -->
                                        <a href="<?php echo url('Cat/index',['cat_id'=>$v['cat_id']]); ?>"><?php echo $v['cat_name']; ?></a>|
                                      <?php endforeach; ?>
                                </div>
                            <?php endforeach; ?>
                            </div>
...
<div class="i_bg bg_color">
                        ...
                        <?php foreach($hotGoods as $val): ?>
                            <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                <div class="box">
                                    ...
                                    <div class="imgbg">
                                        <a href="javascript:void(0)"><img width="160" height="136" src="/uploads/<?php echo $val['goods_thumb']; ?>"></a>
                                    </div>                                        
                                    <div class="name">
                                        <a href="javascript:void(0)">
                                        <h2><?php echo $val['goods_name']; ?></h2>
                                        <?php echo $val['goods_brief']; ?>
                                        </a>
                                    </div>
                                    <div class="price">
                                        <font>￥<span><?php echo $val['shop_price']; ?></span></font> &nbsp;
                                    </div>
                                </div>
                            </li>
                        <?php endforeach; ?>      
    ...
    <div class="i_t mar_10">
    	...
    	<span class="fl"><?php echo $floor['oneName']; ?></span>                
        <span class="i_mores fr">
            <?php foreach($floor['twoList'] as $val): ?>
            <a href="#"><?php echo $val['cat_name']; ?></a>&nbsp; &nbsp; &nbsp; 
           <?php endforeach; ?>
        </span>
    </div>
    <div class="content">
        ...
        <div class="fresh_mid">
        	<ul>
             <?php foreach($floor['goods'] as $val): ?>
            	<li>
                	<div class="name"><a href="#"><?php echo $val['goods_name']; ?></a></div>
                    <div class="price">
                    	<font>￥<span><?php echo $val['shop_price']; ?></span></font> &nbsp; 
                    </div>
                    <div class="img"><a href="#"><img src="/uploads/<?php echo $val['goods_thumb']; ?>" width="185" height="155" /></a></div>
                </li>
            <?php endforeach; ?>                                                    
            </ul>
        </div>
