<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"C:\phpStudy\WWW\tp50\public/../app/admin\view\login\login.html";i:1542704067;}*/ ?>
...
<form method="post" action="<?php echo url('index'); ?>" name='theForm'>
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <td colspan="2" align="right">
          <img class="img"  src="<?php echo captcha_src(); ?>" alt="captcha"  border="1"  style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
      </td>
      </tr>
